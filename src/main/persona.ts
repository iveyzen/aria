...
export const COWATCH_ON_NOTE =
  '【系统】共看模式开启：你和用户正在一起看视频/剧/直播。从现在起持续默默跟进剧情——认真读每帧画面和字幕，把人物、关系、剧情走向记在心里，但不要出声评论。用户问起剧情时你要能接得上。系统偶尔会无声地问你想不想吐槽，到时候再决定。'
export const COWATCH_OFF_NOTE = '【系统】共看模式结束，回到平常的陪伴状态。'

/** 共看模式的无声判断：值得说就写出来，不值得输出 PASS */
export const JUDGE_PROMPT =
  '（无声判断，用户看不到）看最新画面和剧情进展：这一刻值得你出声说一句吗？值得就直接输出你想说的那句话——口语、短、像朋友看剧时随口的反应；不值得就只输出 PASS。大部分时候应该是 PASS。'
